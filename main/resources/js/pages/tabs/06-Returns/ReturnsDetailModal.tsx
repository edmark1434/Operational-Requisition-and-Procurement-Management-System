...
// Inside ReturnsDetailModal.tsx
    ...
    return (
        <>
            {/* UPDATED: Added backdrop-blur-sm and adjusted opacity for blur effect */}
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                                    Return #{returnItem.REFERENCE_NO}
                                </h2>
                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                    Created on {formatDateTime(returnItem.CREATED_AT)}
                                </p>
                            </div>
                            <button
                                onClick={onClose}
                                    ...
                                    <table className="w-full">
                                        ...
                                        {returnItem.ITEMS?.map((item: any) => (
                                            <tr key={item.ID} className="border-b border-sidebar-border last:border-b-0">
                                                ...
                                                <td className="p-3 text-sm text-gray-900 dark:text-white">{item.REASON}</td>
                                            </tr>
                                        ))}
                                        </tbody>
                                    </table>
