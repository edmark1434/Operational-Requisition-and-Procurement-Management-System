        ...
        <div className="bg-sidebar dark:bg-sidebar rounded-lg border border-sidebar-border p-4 md:p-6">
            <div className="space-y-4">
                ...
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search by reference number, supplier, items, or services..."
                        value={searchTerm}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4 w-full lg:flex-1">
                        ...
                        <div className="flex items-end sm:col-span-2 lg:col-span-2">
                            <div className="text-sm text-gray-600 dark:text-gray-400">
                                <span className="font-medium text-gray-900 dark:text-white">{resultsCount}</span> orders found
                            </div>
                        </div>
                    </div>
