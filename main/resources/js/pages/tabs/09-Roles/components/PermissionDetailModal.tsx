...
export default function PermissionDetailModal({
    ...
    const categoryText = permission?.CATEGORY ? permission.CATEGORY.charAt(0).toUpperCase() + permission.CATEGORY.slice(1) : '';
                    ...
                    <div className="flex-shrink-0 p-6 border-b border-sidebar-border bg-white dark:bg-sidebar sticky top-0 z-10">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white">
                                Permission #{permission?.ID} Details
                            </h2>
                            <button
                                onClick={onClose}
                        ...
                        <div className="p-6 space-y-6">
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-900 dark:text-white">
                                        {permission?.ROLE_COUNT} roles have this permission
                                    </p>
                                </div>
                            </div>
                        </div>
